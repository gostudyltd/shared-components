...
export const accordionSectionContent1: TranslationType<AccordionSectionProps> =
  {
    ...
    uk: {
      title: 'FAQ',
      description:
        'Відповідаємо на питання, що часто ставляться, про наші резиденції та умови розміщення',
      data: [
        {
        ...
        },
        {
          ...
          renderText: () => (
            <>
              Методисти курсу — викладачі, носії мови з високою кваліфікацією та
              стажем понад 10 років навчання чеської мови іноземним студентам.
              <br />
              <br />
              <span style={{ fontWeight: '600' }}>
                Mgr. Jana Hudečková
