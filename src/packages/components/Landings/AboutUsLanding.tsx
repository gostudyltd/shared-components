        ...
        data={[
          ...
          },
          {
            ...
            text: getTranslatedText(
              ...
              "Мы предлагаем обучение по программам 2-х видов: сокращенные программы для поступающих в частные вузы и годовые программы подготовки для поступающих в государственные вузы на бюджет (подробная информация описана в разделе «Программы» на нашем сайте). В стоимость программы входит курс иностранного языка, услуги по нострификации аттестата или диплома, предоставление документов для открытия студенческой визы: подтверждение из госвуза и подтверждение из общежития о резервации места; помощь при решении бытовых и организационных вопросов на все время обучения на наших курсах, консультации при выборе специальности и вуза, помощь при подачи документов в приемную комиссию выбранного вами вуза, адаптационная программа. Годовая программа также включает курсы подготовки по предметам, которые абитуриент будет сдавать на вступительных экзаменах (математика, физика, биология, иностранный язык и т.д.) или подготовку к творческим испытаниям.",
              "Ми пропонуємо навчання за програмами 2-х видів: скорочені програми для вступників до приватних вишів та річні програми підготовки для вступників до державних вишів на бюджет (докладна інформація описана у розділі «Програми» на нашому сайті). У вартість програми входить курс іноземної мови, послуги з нострифікації атестата або диплома, надання документів для відкриття студентської візи: підтвердження з державного вишу та підтвердження з гуртожитку про резервацію місця; допомога у вирішенні побутових та організаційних питань на весь час навчання на наших курсах, консультації під час вибору спеціальності та вишу, допомога під час подання документів до приймальної комісії обраного вами вишу, адаптаційна програма. Річна програма також включає курси підготовки з предметів, які абітурієнт складатиме на вступних іспитах (математика, фізика, біологія, іноземна мова тощо) або підготовку до творчих випробувань."
            ) as string,
          },
        ]}
      />
