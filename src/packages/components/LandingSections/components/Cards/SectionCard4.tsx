...
export const SectionCard4: React.FC<SectionCard4Props> = (props) => {
  ...
  return (
    <Stack
      ...
      sx={{
        backgroundColor: isHighlighted ? '#E1F5FE' : '#F7F7F7',
      }}
      gap={{ xs: '18px', sm: '32px' }}
    >
      {getPicture(
        ...
        image.width,
        image.height,
        { width: '100%', maxWidth: { xs: '400px', sm: '285px' }, borderRadius: { xs: '10px', sm: '20px' } },
        {
          width: '100%',
          maxWidth: { xs: '400px', sm: '285px' },
          height: { xs: '162px', sm: undefined },
      ...
      <Stack alignItems={'center'}>
        ...
        <Typography fontSize={{ xs: '.75rem', sm: '1.125rem' }} fontFamily={montserratFamily} color={'#606F87'}>
          {text}
        </Typography>
      </Stack>
    </Stack>
